# Customized React Redux Starter Kit

[![Join the chat at https://gitter.im/icandoeverything/custom-react-redux-starter-kit](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/icandoeverything/custom-react-redux-starter-kit?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Build Status](https://travis-ci.org/icandoeverything/custom-react-redux-starter-kit.svg?branch=master)](https://travis-ci.org/icandoeverything/custom-react-redux-starter-kit?branch=master)
[![dependencies](https://david-dm.org/icandoeverything/custom-react-redux-starter-kit.svg)](https://david-dm.org/icandoeverything/custom-react-redux-starter-kit)
[![devDependency Status](https://david-dm.org/icandoeverything/custom-react-redux-starter-kit/dev-status.svg)](https://david-dm.org/icandoeverything/custom-react-redux-starter-kit#info=devDependencies)
...
After confirming that your development environment meets the specified [requirements](#requirements), you can create a new project based on `custom-react-redux-starter-kit` in one of two ways:
...
```bash
$ git clone https://github.com/icandoeverything/custom-react-redux-starter-kit.git <my-project-name>
$ cd <my-project-name>
```
...
The application structure presented in this boilerplate is **fractal**, where functionality is grouped primarily by feature rather than file type. Please note, however, that this structure is only meant to serve as a guide, it is by no means prescriptive. That said, it aims to represent generally accepted guidelines and patterns for building scalable applications. If you wish to read more about this pattern, please check out this [awesome writeup](https://github.com/icandoeverything/custom-react-redux-starter-kit/wiki/Fractal-Project-Structure) by [Justin Greenberg](https://github.com/justingreenberg).
...
* [Starting out with custom-react-redux-starter-kit](https://suspicious.website/2016/04/29/starting-out-with-custom-react-redux-starter-kit/) is an introduction to the components used in this starter kit with a small example in the end.

## FAQ

Having trouble? Check out our [FAQ](https://github.com/icandoeverything/custom-react-redux-starter-kit/wiki/FAQ:-Frequently-Asked-Questions) or submit an issue. Please be considerate by only posting issues that are directly related to this project; questions about how to implement certain React or Redux features are both best suited for StackOverflow or their respective repositories.
