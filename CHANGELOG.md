...
### Improvements
* Migrated to Fractal Project Structure, huge thanks to [justingreenberg](https://github.com/justingreenberg). See https://github.com/icandoeverything/custom-react-redux-starter-kit/pull/684 for details and discussion.
...
### Fixes
* Modified webpack manifest initialization to prevent syntax errors in some environments (https://github.com/icandoeverything/custom-react-redux-starter-kit/issues/572)
...
* Created a `no-server` branch [here](https://github.com/icandoeverything/custom-react-redux-starter-kit/tree/no-server) to make it easier for users who don't care about Koa.
...
* Updates all `.jsx` files to `.js`. (https://github.com/icandoeverything/custom-react-redux-starter-kit/issues/37)
...
* Fixes potential spacing issues when Webpack tries to load a config file.
  - Thanks to [nuragic](https://github.com/nuragic) for his [PR](https://github.com/icandoeverything/custom-react-redux-starter-kit/pull/32)
...
#### Improvements
* Cleans up/removes example code per https://github.com/icandoeverything/custom-react-redux-starter-kit/issues/20

0.3.1
-----

#### Fixes
* https://github.com/icandoeverything/custom-react-redux-starter-kit/issues/19
